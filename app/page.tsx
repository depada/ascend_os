...
const levels = ["Spark", "Initiate", "Builder", "Operator", "Relentless", "Apex"];
...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.18),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(37,99,235,0.16),transparent_26%)]" />
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-24 px-6 py-8 sm:px-10 lg:px-12 lg:py-10">
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-lg font-semibold tracking-tight text-white">AscendOS</p>
              <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Execution platform</p>
            </div>
          </div>
        ...
        <section className="grid items-start gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          ...
          >
            <div className="space-y-5">
              ...
              <p className="max-w-3xl text-2xl font-medium leading-9 text-slate-200 sm:text-[2rem] sm:leading-10">
                Turn any desired state into tracked execution.
              </p>
              <p className="max-w-2xl text-base leading-8 text-slate-400 sm:text-lg">
                A customizable command center for tracking goals, habits, skills, platforms, events, routes, reviews, and daily execution across career, fitness, finance, learning, spirituality, discipline, and any personal mission.
              </p>
            </div>
          ...
          >
            <Card className="border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.88),rgba(2,6,23,0.96))] text-white">
              <CardHeader className="space-y-3">
                <Badge className="w-fit border-sky-400/20 bg-sky-400/10 text-sky-100">Problem statement</Badge>
                <CardTitle className="text-2xl text-white sm:text-3xl">Most people fail because their goals stay vague.</CardTitle>
              ...
              <CardContent className="space-y-5">
                ...
                <div className="rounded-3xl border border-white/10 bg-slate-950/70 p-5">
                  ...
                  <div className="mt-4 grid grid-cols-12 items-end gap-2">
                    {[34, 52, 46, 60, 68, 82, 71, 55, 63, 77, 88, 94].map((height, index) => (
            ...
            <Card className="border-white/10 bg-white/6 text-white">
              <CardHeader className="space-y-3">
                <Badge variant="secondary" className="w-fit border-white/10 bg-white/6 text-slate-200">
                  Level system preview
                </Badge>
                <CardTitle className="text-2xl text-white">Progress is visible from the first session.</CardTitle>
              </CardHeader>
        ...
        <section className="space-y-6">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <Badge className="mb-3 w-fit border-white/10 bg-white/6 text-slate-200">Core capabilities</Badge>
              <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">Everything the execution layer needs, nothing wasteful.</h2>
            </div>
            <p className="max-w-2xl text-sm leading-7 text-slate-400 sm:text-base">
              Designed to support any goal domain without hardcoding a single career path, language, platform, or template.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <Card className="h-full border-white/10 bg-white/6 text-white transition-transform duration-300 hover:-translate-y-1 hover:border-sky-400/20 hover:bg-white/8">
          ...
          <Card className="border-white/10 bg-[linear-gradient(135deg,rgba(14,165,233,0.18),rgba(15,23,42,0.92))] text-white">
            <CardContent className="flex h-full flex-col justify-between gap-8 p-8">
              <div className="space-y-4">
                <Badge className="w-fit border-sky-400/20 bg-sky-400/10 text-sky-100">Execution mindset</Badge>
                <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">A serious system for people who want compounding progress.</h2>
              </div>
              <p className="max-w-2xl text-base leading-8 text-slate-300">
                AscendOS gives you a place to define identity, direction, goals, effort, time, and constraints before the work begins.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-white/10 bg-white/6 text-white">
            <CardContent className="flex h-full flex-col justify-center gap-6 p-8">
              ...
              <div className="space-y-3">
                <h2 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">Build your execution system.</h2>
                <p className="text-base leading-7 text-slate-400">
                  Create your account and start shaping a dashboard that reflects your mission instead of forcing you into one.
                </p>
              </div>
              <div className="flex flex-wrap gap-3">
                <Button asChild size="lg">
