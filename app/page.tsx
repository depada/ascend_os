              ...
              >
                <div className="space-y-5">
                  ...
                  >
                    ...
                    skills, platforms, events, routes, reviews, and daily
                    execution across career, fitness, finance, learning,
                    spirituality, discipline, and any personal mission.
                  </motion.p>
                </div>
            ...
            <section className="space-y-6 [content-visibility:auto] [contain-intrinsic-size:1px_1400px]">
              <div className="flex flex-wrap items-end justify-between gap-4">
                ...
                <p className="max-w-2xl text-sm leading-7 text-slate-400 sm:text-base">
                  Designed to support any goal domain without hardcoding a
                  single career path, language, platform, or template.
                </p>
              </div>
              ...
              <Card className="border-white/10 bg-[linear-gradient(135deg,rgba(14,165,233,0.18),rgba(15,23,42,0.92))] text-white">
                <CardContent className="flex h-full flex-col justify-between gap-8 p-8">
                  ...
                  <p className="max-w-2xl text-base leading-8 text-slate-300">
                    AscendOS gives you a place to define identity, direction,
                    goals, effort, time, and constraints before the work begins.
                  </p>
                </CardContent>
              </Card>
