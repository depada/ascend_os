...
const cards = [
  {
    ...
    icon: Target,
    description: "Set your current state, desired state, and active domains.",
  },
  {
    title: "Active Goals",
    value: "0",
    icon: CheckCircle2,
    description: "No goals have been configured yet.",
  },
  {
    title: "Execution Score",
    value: "—",
    icon: TrendingUp,
    description: "Your score will appear after onboarding.",
  },
  {
    title: "Daily Completion",
    value: "0%",
    icon: TimerReset,
    description: "Nothing is being tracked yet.",
  },
  {
    title: "Weekly Progress",
    value: "0 / 7",
    icon: Flame,
    description: "The weekly cadence starts after setup.",
  },
  {
    title: "Time vs Effort",
    value: "—",
    icon: TrendingUp,
    description: "This chart will compare time capacity with intensity.",
  },
  {
    title: "Domain Progress",
    value: "0 domains",
    icon: Target,
    description: "Career, fitness, finance, learning, and more.",
  },
  {
    title: "Streaks",
    value: "0",
    icon: Flame,
    description: "Consistency signals will appear here.",
  },
  {
    title: "Risk Warnings",
    value: "None",
    icon: AlertTriangle,
    description: "No configuration means no detected risks yet.",
  },
  {
    title: "Suggested Next Actions",
    value: "Start onboarding",
    icon: ArrowRight,
    description: "Build the foundation before tracking execution.",
  },
];
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-400 sm:text-base">
            This foundation is ready for onboarding. Until then, the dashboard
            stays intentionally empty and focused.
          </p>
        </div>
        ...
        <CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              Once onboarding is implemented, this card will evolve into a real
              state-aware summary.
            </p>
          </div>
