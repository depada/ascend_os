...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-sky-500 text-slate-950 shadow-lg shadow-sky-950/30 hover:bg-sky-400",
        secondary:
          "bg-white/8 text-slate-100 ring-1 ring-white/12 hover:bg-white/12",
        outline:
          "border border-white/14 bg-transparent text-slate-100 hover:bg-white/8",
